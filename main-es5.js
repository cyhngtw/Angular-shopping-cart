...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.logChange = function (index) {
                    console.log(index);
                };
                AppComponent.prototype.logData = function (row) {
                    console.log(row);
                };
                ...
                AppComponent.prototype.ngOnInit = function () {
                    ...
                    this.db.list('/courses').valueChanges()
                        .subscribe(function (courses) { return console.log(courses); });
                };
                return AppComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MessengerService = /** @class */ (function () {
                function MessengerService(db) {
                    this.db = db;
                }
                MessengerService.prototype.AddToCart = function (course) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.db.list('/shoppingCart').push({
                ...
                MessengerService.prototype.AddCourseCart = function (idCart, courseAdd) {
                    var _this = this;
                    console.log('addCourse', courseAdd);
                    this.db.object('/shoppingCart/' + idCart + '/items/' + courseAdd.key)
                        .snapshotChanges()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).subscribe(function (courseCart) {
                        console.log(courseCart);
                        if (!courseCart.key) {
                            _this.db.list('/shoppingCart/' + idCart + '/items/').set(courseAdd.key, { course: courseAdd });
                        }
                    });
                };
                MessengerService.prototype.getListItemsShoppingCart = function () {
                    var cartId = localStorage.getItem('cartId');
                    return this.db.list('/shoppingCart/' + cartId + '/items/')
                        .snapshotChanges()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (courses) { return courses.map(function (c) { return (Object.assign({ key: c.payload.key }, c.payload.exportVal())); }); }));
                };
                MessengerService.prototype.deleteCourseShoppingCart = function (id) {
                    var cartId = localStorage.getItem('cartId');
                    return this.db.object('/shoppingCart/' + cartId + '/items/' + id).remove();
                };
                MessengerService.prototype.getListItemsShoppingCartMapCourses = function () {
                    var cartId = localStorage.getItem('cartId');
                    return this.db.list('/shoppingCart/' + cartId + '/items/')
                        .snapshotChanges()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (courses) { return courses.map(function (c) { return (Object.assign({ key: c.payload.key }, c.payload.val().course)); }); }));
                };
                MessengerService.prototype.clearShpoppingCart = function () {
                    var cartId = localStorage.getItem('cartId');
                    this.db.object('/shoppingCart/' + cartId + '/items/').remove();
                };
                return MessengerService;
            }());
            MessengerService.ctorParameters = function () { return [
                { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
            ]; };
            ...
            var ProductService = /** @class */ (function () {
                ...
                ProductService.prototype.getCategories = function () {
                    return this.db.list('categories')
                        .snapshotChanges()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (change) { return change.map(function (c) { return (Object.assign({ key: c.payload.key }, c.payload.exportVal())); }); }));
                };
                ProductService.prototype.getCourses = function () {
                    return this.db.list('/courses')
                        .snapshotChanges()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (change) { return change.map(function (c) { return (Object.assign({ key: c.payload.key }, c.payload.exportVal())); }); }));
                };
                ProductService.prototype.AddToCart = function (course) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var cartId, cart;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                ...
                ProductService.prototype.AddCourseCart = function (idCart, courseAdd) {
                    var _this = this;
                    console.log('addCourse', courseAdd);
                    this.db.object('/shoppingCart/' + idCart + '/items/' + courseAdd.key)
                        .snapshotChanges()
            ...
            var CartComponent = /** @class */ (function () {
                ...
                CartComponent.prototype.ngOnInit = function () {
                    ...
                    this.msg.getListItemsShoppingCart()
                        .subscribe(function (coursesShopping) {
                        _this.nbrShoppingCourse = coursesShopping.length;
                        //this.loadCartItems();
                    });
                    this.msg.getListItemsShoppingCartMapCourses()
                        .subscribe(function (courses) { return _this.coursesShopping = courses; });
                };
                // loadCartItems()
                // {
                ...
                CartComponent.prototype.getTotal = function () {
                    var total = 0;
                    this.coursesShopping.forEach(function (course) {
                        total += course.price;
                    });
                    return total;
                };
                CartComponent.prototype.Delete = function (row) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductListComponent = /** @class */ (function () {
                function ProductListComponent(productService, msg) {
                ...
                ProductListComponent.prototype.ngOnInit = function () {
                    ...
                    this.productService.getCategories()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (categories) { return _this.productService.getCourses().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (courses) { return _this.msg.getListItemsShoppingCart().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (coursesShopping) { return [categories, courses, coursesShopping]; })); })); })).subscribe(function (_a) {
                        var categories = _a[0], courses = _a[1], coursesShopping = _a[2];
                        _this.categories = categories;
                        _this.courses = courses;
                        _this.coursesShoppingCart = coursesShopping;
                        console.log('courseShopping : ' + coursesShopping);
                    });
                };
                ProductListComponent.prototype.getCoursesByCategorie = function (key) {
                    return this.courses.filter(function (course) { return course.categorie == key; });
                };
                ProductListComponent.prototype.AddToCart = function (course) {
                    console.log(course);
                    this.msg.AddToCart(course);
                };
                ProductListComponent.prototype.DeleteToCart = function (course) {
